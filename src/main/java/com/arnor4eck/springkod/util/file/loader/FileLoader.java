...
public interface FileLoader {
    FileImpl load(String key) throws FileNotFoundInStorageException;
    FileImpl load(long datasitoryId, FileType fileType) throws FileNotFoundInStorageException;
    List<FileImpl> loadAll(long datasitoryId) throws FileNotFoundInStorageException;
}
